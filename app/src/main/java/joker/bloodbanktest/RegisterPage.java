...
public class RegisterPage extends Activity implements AdapterView.OnItemSelectedListener{
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!password.equals(conPassword))
                {
                    ...
                    Toast.makeText(RegisterPage.this,"Password Don't Match !",Toast.LENGTH_SHORT).show();
                        ...
                        ||weight.isEmpty())
                {
                    Toast.makeText(RegisterPage.this,"Please, Fill All The Field !",Toast.LENGTH_SHORT).show();

                }
                else if(helper.searchEmail(email))
                ...
                else
                {
                    ...
                    c.setdWeight(weight);
                    c.setdPass(password);
                    Toast msg = Toast.makeText(RegisterPage.this,"Regestration Completed !",Toast.LENGTH_SHORT);
                    msg.show();
    ...
    private void showDate(int year, int month, int day) {
        dLastDate.setText(day+"-"+month+"-"+year);
    }
